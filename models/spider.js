...
class spider {
    ...
    static async saveText() {
        const id = await this.getSartId();
        const article = await this.getTextById(id);
    ...
    static async saveHtml() {
        const id = await this.getSartId();
        const article = await this.getHtmlById(id);
